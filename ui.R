...
# GitHub: https://github.com/sonisa/Datascience-Capstone-Project
    ...
    navbarPage("Next Word Predict",
               ...
               tabPanel("About",
                        ...
                        div("Next Word Predict is a Shiny app that uses a text
                            ...
                            br(),
                            img(src = "github.png"),
                            a(target = "_blank", href = "https://github.com/sonisa/Datascience-Capstone-Project",
                              "Next Word Predict")),
                        br(),
                        h3("About Me"),
                        br(),
                        div("My name is Sonisa Sharma and I am a
                            Research Associate at Noble Research Institute ",
                            img(src = "linkedin.png"),
                            a(target = "_blank", href="https://www.linkedin.com/in/sonisa/", "Sonisa")),
               )
    )
)
